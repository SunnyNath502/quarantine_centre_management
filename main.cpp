                    ...
                    if (age > 0 && age <= 40)
                    {
                        if (room_check(101, 300, covid_map))
                        {
                            ...
                            while (covid_map[room] != NULL || (room <= 101 || room > 300))
                            {
                                ...
                                {
                                    cout << "Attention!" << endl
                                         << "You have choosed invalid room number,please choose a room between 101 to 300 : ";
                                    cin >> room;
                                }
                                else
                                {
                            ...
                            cout << endl
                                 << "congratulations!,room no. : " << room << " is now allocated to you" << endl;
                        }
                        else
                        {
                    ...
                    else if (age > 40 && age <= 60)
                    {
                        if (room_check(1, 100, covid_map))
                        {
                            ...
                            while (covid_map[room] != NULL || (room <= 1 || room > 100))
                            {
                                ...
                                {
                                    cout << "Attention!" << endl
                                         << "You have choosed invalid room number,please choose a room between 1 to 100 : ";
                                    cin >> room;
                                }
                                else
                                {
                    ...
                    else
                    {
                        if (room_check(301, 500, covid_map))
                        {
                            ...
                            while (covid_map[room] != NULL || (room <= 300 || room > 500))
                            {
                                ...
                                {
                                    cout << "Attention!" << endl
                                         << "You have choosed invalid room number,please choose a room between 301 to 500 : ";
                                    cin >> room;
                                }
                                else
                                {
